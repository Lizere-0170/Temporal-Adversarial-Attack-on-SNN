...
"""
Baseline SNN using SpikingJelly's LIFNode for preliminary results
----------------------------------------
...
class BaselineSNN(nn.Module):
    def __init__(self,
        ...
        self.fc2 = nn.Linear(hidden_neurons, n_classes)
